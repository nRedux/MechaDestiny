...
namespace Pathfinding.Graphs.Navmesh {
	...
	public class NavmeshUpdates {
		...
		static Rect ExpandedBounds (Rect rect) {
			rect.xMin -= TileHandler.TileSnappingMaxDistance * Int3.FloatPrecision;
			rect.yMin -= TileHandler.TileSnappingMaxDistance * Int3.FloatPrecision;
			rect.xMax += TileHandler.TileSnappingMaxDistance * Int3.FloatPrecision;
			rect.yMax += TileHandler.TileSnappingMaxDistance * Int3.FloatPrecision;
			return rect;
		}
